...
The palette, the type split, and the `.pi-*` classes are documented in
[docs/pi-visual-language.md](docs/pi-visual-language.md); `app/globals.css`
itself is the source of truth for the full token list.

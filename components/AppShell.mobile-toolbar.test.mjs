...
test("uses a compact narrow-mobile toolbar with a floating action layer", () => {
  ...
  for (const action of ["search", "history", "name", "agents", "branches", "system", "tools"]) {
...
test("keeps the mobile action layer open after using an expanded action", () => {
  ...
  assert.doesNotMatch(source, /renderThemeButton|data-mobile-toolbar-action=\{mobile \? "theme"/);
  assert.doesNotMatch(source, /renderLanguageButton|toggleTopPanel\("language"/);

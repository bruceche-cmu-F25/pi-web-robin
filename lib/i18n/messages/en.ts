...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "robin.assistant.placeholder": "Search links, todos, and events, or tell pi what to do…",
    ...
    "robin.calendar.dayTooltip": "{date} — {count} event(s)",
    ...
    "robin.todos.empty": "Nothing open. Ask pi to add something.",

...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "uiStyle.balanced": "Balanced Pi style (click for Classic)",
    "uiStyle.classic": "Classic Pi Web style (click for Balanced)",
    ...
    "robin.todos.addButton": "Add",
    "robin.todos.placeholder": "Add a task…",
    "robin.todos.empty": "Nothing open. Ask pi to add something, or use the field above.",
    ...
    "robin.google.disconnected": "Google Calendar not connected",
    ...
    "i18n.unlinkExtension": "Unlink",
    "i18n.unlinkExtensionKeepsSource": "Remove this extension symlink without deleting its source",
    "i18n.unlinkExtensionConfirm": "Unlink {name}? Its source files will not be deleted.",
    "i18n.extensionLinkRemoved": "Extension symlink removed; source files were kept.",
